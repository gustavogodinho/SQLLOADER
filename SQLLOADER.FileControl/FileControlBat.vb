Public Class FileControlBat
    Public Function CreateFileControlBat(sUser As String, cmbDataBase As String, sPwd As String, DefaultContrlFile As String, cmbIntoTable As String, sRowsCommit As Integer) As String
